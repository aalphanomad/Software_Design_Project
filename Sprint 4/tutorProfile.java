...
public class tutorProfile extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        courses[0] = courses[0].substring(14, courses[0].length() - 1);
        courses[1] = courses[1].substring(12, courses[1].length() - 1);
        courses[2] = courses[2].substring(12, courses[2].length() - 1);
        courses[3] = courses[3].substring(12, courses[3].length() - 1);
        courses[4] = courses[4].substring(12, courses[4].length() - 3);
