...
//Sends the course,name,student number,venue and time to the qrGenerator Class
            ...
            qrGenerator.Global.setCourse(topic[0]+"-"+topic[1]);
           ...
           CharSequence df=  android.text.format.DateFormat.format("dd MMM yyyy",new java.util.Date());


            BackgroundWorker backgroundWorker = new BackgroundWorker(this);

            backgroundWorker.execute("booking", name, stud_num, course, df.toString(), venue, startTime, endTime,activity_selected);
