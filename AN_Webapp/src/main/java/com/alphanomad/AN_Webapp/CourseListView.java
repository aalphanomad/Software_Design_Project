...
{	//Global Variables
	...
	{//Added ensure that additional textfields and buttons are not added if the user continuously clickes the "delete a course" button
		Added=false;
		view_courses();
	}
	...
	private void view_courses()
	{
		...
		g.addColumn(unused -> "View Info",
				...
				new ButtonRenderer(e ->
				{
					...
					//The unformatted names array which contains the names of the tutors/lecturers for the selected course(Unformatted in the sense
