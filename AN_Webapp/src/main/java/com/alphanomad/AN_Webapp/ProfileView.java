...
public class ProfileView extends VerticalLayout implements View{
    ...
    public void enter(ViewChangeEvent event)
    {
    	...
    	Button home_button = new Button("go to main view",
	            btn_event -> getUI().getNavigator().navigateTo("lectmain"));
    ...
    public Panel make_user_info_panel(String name, String student_number)
    {
    	...
    	ExternalResource resource = new ExternalResource ("https://sophosnews.files.wordpress.com/2014/04/anonymous-250.jpg?w=100");
