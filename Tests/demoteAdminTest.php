...
class demoteAdminTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var PDO
     */
    ...
    public function testDemoteAdmin()
    {
        include 'demote_admin.php';
        $this->assertEquals('true', demote_admin("3",$this->myqli_link));
    }
}
?>