...
class changeRoleTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var PDO
     */
    ...
    public function testChangeRole()
    {
        ...
        $this->assertEquals('false', change_role("9099090990","0",$this->myqli_link));
        $this->assertEquals('true', change_role("1","0",$this->myqli_link));
    }
}
?>