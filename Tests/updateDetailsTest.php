...
class updateDetailsTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testUpdateCourses()
    {
        ...
        $this->assertEquals('0', update_details("10","COMS3003","COMS1018","COMS1017","COMS3005","COMS3008",$this->myqli_link));
        $this->assertEquals('0', update_details("10","COMS3003","COMS1018","COMS1017","COMS3005",NULL,$this->myqli_link));
        $this->assertEquals('0', update_details("10","COMS3003","COMS1018","COMS1017",NULL,NULL,$this->myqli_link));
        $this->assertEquals('0', update_details("10","COMS3003","COMS1018",NULL,NULL,NULL,$this->myqli_link));
        $this->assertEquals('0', update_details("10","COMS3003",NULL,NULL,NULL,NULL,$this->myqli_link));
    }
}
?>